...
| `AgentEvent` | 归一化事件的可辨识联合（判别字段 `kind`）：`status / user_input / user_question / user_question_result / compact / system_init / thinking / assistant_text / tool_use / tool_result / result / error` |
